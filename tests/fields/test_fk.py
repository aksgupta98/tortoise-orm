...
class TestDeconstructSourceField:
    ...
    @pytest.mark.asyncio
    async def test_fk_keeps_declared_source_field(self, db):
    ...
    @pytest.mark.asyncio
    async def test_o2o_keeps_declared_source_field(self, db):
    ...
    @pytest.mark.asyncio
    async def test_fk_without_source_field_uses_default_column(self, db):
    ...
    @pytest.mark.asyncio
    async def test_source_field_equal_to_field_name(self, db):
    ...
    def test_before_init_models_keeps_declared_source_field(self):
    ...
    @pytest.mark.asyncio
    async def test_source_field_is_always_a_real_column(self, db):
